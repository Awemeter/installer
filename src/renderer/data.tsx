                        ...
                        <Translation>
                            {
                                (t) => <>
                                    ...
                                    <p>{t('AircraftSection.A32NX.Versions.Experimental.WarningContent.PleaseRead')} <a onClick={() => shell.openExternal("https://github.com/flybywiresim/a32nx/blob/autopilot/docs/README.md")}>{t('AircraftSection.A32NX.Versions.Experimental.WarningContent.ThisGuide')}</a>.</p>
